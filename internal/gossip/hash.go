...
//   - Batched eventual-consistency replication
...
//
//	// Find N replicas for replication/repairs
...
//
// Safe to call concurrently (uses read lock).
...
//	ring.Add("node3")
//
//	// Eventual consistency replication (N=3)
...
//
// Use cases:
//   - Eventual consistency writes: Write to N nodes via gossip
//   - Eventual consistency reads: Read from coordinator with read-repair
